...
/*! \brief Class for the markup table implementation for OTM markup tables
*/

class  OtmMarkupTable: public OtmMarkup 
{
  private:
  ...
  OtmMarkupTable(){ pInfo = NULL; pszBasePath = NULL; }

  OtmMarkupTable( PMARKUPINFO pMarkupInfo, char *pszPath )
  {
    pInfo = pMarkupInfo;
    pszBasePath = pszPath; 
  }
...
#endif // #ifndef _OTMMARKUPTABLE_H_
