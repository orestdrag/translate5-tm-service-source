...
#ifndef _UserMarkupTablePlugin_H_
#define _UserMarkupTablePlugin_H_
...
class UserMarkupTablePlugin: public OtmMarkupPlugin
/*! \brief Translation memory plugin
	This plugin implements the user markup table plugin for OpenTM2.
*/
...
#endif // #ifndef _UserMarkupTablePlugin_H_