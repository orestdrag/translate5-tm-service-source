...
public:
    ...
    static std::recursive_mutex loadingTm;
    ...
    static int DeleteFile(const std::string& path, bool suppressLogs = false);
    ...
    */
    ...
    enum FilesystemHelpersMessage{
        ...
        //FILEHELPER_ERROR_DATA_SIZE_BIGGER_THAN_ALLOWED_FILEBUFFER_SIZE,
